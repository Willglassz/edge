...
description: A skill to send WhatsApp messages via webhook.
---
...
3.  **Format:** Telefon numarasının uluslararası formatta (+ ile başlayan) olmasını tercih edin, ancak kullanıcının sadece rakam verirse kabul edin.
